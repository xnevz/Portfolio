import { inria, saira } from '@/app/helpers/fonts';
...
export default function Home() {
    ...
    return (
        <>
            ...
            <section className='flex gap-20 items-center justify-evenly min-h-screen pt-36 pb-36'>
                ...
                <div style={{ gridColumn: '2/3' }} className='hidden md:flex gap-6'>
                    ...
                    <div className='flex flex-col gap-3 items-center self-end ms-auto'>
                        ...
                        <FaInstagram size={30} className='opacity-80 hover:opacity-100 transition-all hover:scale-105' />
                        <FaTwitter size={30} className='opacity-80 hover:opacity-100 transition-all hover:scale-105' />
                ...
                <section className='flex flex-col sm:grid sm:grid-cols-[auto_1fr]  gap-4 mt-10'>
                    <Sticky className='col-span-2'>
                        <h2 style={{
                            ...
                            gridRow: '1/2',
                            marginInlineEnd: -20
                        }} className='text-4xl pb-4'>About</h2>
                    ...
                    <div style={{
                        ...
                        gridColumn: '2/3',
                        gridRow: '2/3',
                    }} className='text-3xl [&_p]:mb-2 text-justify'>
            ...
            <MyElement name="education">
                <section className='-m-10 mt-10 p-10 '>
                    <Sticky>
                        <h2 className={'text-4xl mb-4 ' + saira.className}>Education</h2>
                        <HLine />
                    </Sticky>
                        ...
                        <div className='flex gap-5 flex-col'>
                            {educations.map(({ title, date, location, subtitle }, index) => (
                                <div key={index} className='flex flex-col p-5 flex-wrap items-center gap-4 rounded-2xl bg-white bg-opacity-5'>
                                    ...
                                    <h3 style={saira.style} className='text-3xl mb-0 text-center'>
                                        {title}
            ...
            <MyElement name="projects">
                <section className='mt-10'>
                    <Sticky>
                        <h2 style={{
                            ...saira.style,
                        }} className='text-4xl mb-4'>Projects</h2>
                    ...
                    <div className='flex flex-col gap-10 mt-10'>
                        {projects.map(({ description, image, title, stack, url, subtitle }, index) => (
                            ...
                            <div key={index}
                                className={'flex flex-col gap-10 p-10 items-center center rounded-2xl bg-white bg-opacity-5 ' + (index % 2 == 0 ? 'lg:flex-row' : 'lg:flex-row-reverse')}>

                                <div className='flex flex-col gap-2'>
                                    <h3 style={saira.style} className={'text-3xl flex items-end gap-2 flex-wrap ' + (index % 2 === 0 ? 'flex' : 'flex-row-reverse')}>
                                        <span className={'flex flex-wrap items-end gap-2 ' + (index % 2 === 0 ? 'me-auto' : 'flex-row-reverse ms-auto')}>
                                            <span>{title}</span>
                                            <span className={'text-lg text-gold font-bold ' + inria.className}>( {subtitle} )</span>
                                        </span>
                                ...
                                <a href={url} target='_blank'>
                                    <Image
                                        ...
                                        height={300}
                                        width={500}
                                        className={'object-cover rounded-2xl ' + (index % 2 == 0 ? 'lg:-me-20 lg:rounded-s-2xl' : 'lg:-ms-20 lg:rounded-e-2xl') + ''}
                                        style={{
                                            objectPosition: '0 0',
                                        }} />
                                </a>
            ...
            <MyElement name="testimonials">
                <section className='mt-10'>
                    <Sticky>
                        <h2 className={'text-4xl mb-4 ' + saira.className}>Testimonials</h2>
                        <HLine />
                    </Sticky>

                    <div className='flex flex-col gap-10 mt-10'>
                        {testimonials.map(({ name, country, description, image, countryCode }, index) => (
                            <div key={index}
                                className={'flex flex-col sm:grid sm:grid-cols-[auto_auto_auto_auto_1fr] sm:grid-rows-[auto_1fr] items-center gap-2 bg-opacity-5 p-10 rounded-md' + (index % 2 === 0 ? ' bg-orange-500 flex-row-reverse' : ' bg-indigo-500')}>
            ...
            <MyElement name="reach-me">
                <section
                    ...
                    <span className='w-full bg-gold' style={{ height: 1 }} />
                    <h3 style={saira.style} className='text-4xl'>Reach me</h3>
                    <span className='w-full bg-gold col-start-3' style={{ height: 1 }} />

                    <div className="flex gap-4 col-start-1 col-end-4 m-10 flex-wrap items-center justify-center w-full">

                        <div className="grow">
                            <ReachMe />
                        </div>
                        <div className='flex flex-col items-center gap-2 grow'>
                            <TransparentButton className='max-w-full' leftIcon={<MdEmail size={20} color={gold} />}>
                                <a href='mailto:abdelkrime.bettayeb@gmail.com' className='text-ellipsis overflow-hidden w-full'>Abdelkrime.Bettayeb@gmail.com@gmail.com</a>
                            </TransparentButton>
                            <TransparentButton className='max-w-full' leftIcon={<FaWhatsapp size={20} color={gold} />}>
                                <a href='https://wa.me/+213540606959' className='text-ellipsis overflow-hidden w-full'>+213 540 606 959</a>
                            </TransparentButton>
                            <TransparentButton className='max-w-full' leftIcon={<MdLocationCity size={20} color={gold} />}>
                    ...
                    <span className='w-full bg-gold row-start-3 col-span-3' style={{ height: 1 }} />
                </section>
            </MyElement>
            ...
            <section className='flex flex-col gap-4 items-center'>
                ...
                <p style={inria.style} className='text-2xl text-center'>I hope you enjoyed my portfolio. If you would like to work with me, feel free to <span className='text-gold'>reach out !</span></p>
